...
return [
    ...
    'settings.use_code_snippet.label' => 'Use code snippet copied from Facebook page settings instead?',
    'settings.code_snippet.label' => 'Code snippet copied from Facebook page settings',
    ...
    'settings.use_code_snippet.instructions' => 'Enabling this setting will discard attribute settings above and insert the code pasted in the "{settings.code_snippet.label}" field.',
    'settings.code_snippet.instructions' => 'Paste here the code snippet copied from your Facebook page. If "{settings.use_code_snippet.label}" is enabled then the code snippet (and its attributes) pasted here will be inserted into your pages.',
